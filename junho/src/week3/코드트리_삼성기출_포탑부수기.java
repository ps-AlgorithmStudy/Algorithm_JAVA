...
public class 코드트리_삼성기출_포탑부수기 {
	static class Turret {
		...
		public String toString() {
			return String.format("{power:%d, recentTime:%d, pos:(%d, %d), isAffected : %d}", power, recentTime, r, c,
					(isAffected ? 1 : 0));
		}
	...
	static class SortTurret implements Comparator<Turret> {
		...
		public int compare(Turret o1, Turret o2) {
			if (o1.power != o2.power)
				return Integer.compare(o1.power, o2.power); // 이미 오름차순이라면 -1이 반환되겠지
			if (o1.recentTime != o2.recentTime)
				return Integer.compare(o2.recentTime, o1.recentTime); // recentTime에 대해선 내림차순 // 값이 제일 큰게 앞에 오도록
			if (o1.r + o1.c != o2.r + o2.c)
				return Integer.compare(o2.r + o2.c, o1.r + o1.c); // 좌표의 합에 대해선 내림차순 // 합이 제일 큰게 앞에 오도록
			return o2.c - o1.c;
		}
	}
